...
import { getAdminBusinesses } from "@/lib/queries";
...
export default async function AdminBusinessesPage({ params }: Props) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-semibold">{t("businesses")}</h2>
      <BusinessesTable businesses={businesses} locale={locale as Locale} />
    </div>
  );
}
